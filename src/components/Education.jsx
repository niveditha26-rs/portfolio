  ...
  return (
    ...
    >
      ...
      <div className="bg-[#efefef] w-full max-w-7xl shadow-2xl px-8 md:px-20 py-16">
        ...
        {/* EDUCATION TIMELINE */}
        <div className="relative border-l-4 border-[#f5b932] ml-4 space-y-16">

          {/* CARD 1 */}
          <div className="relative pl-10">

            {/* DOT */}
            <div className="absolute -left-[18px] top-2 w-8 h-8 bg-[#f5b932] rounded-full border-4 border-[#efefef]"></div>

            {/* CONTENT */}
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition duration-500">

              <p className="text-sm uppercase tracking-[3px] text-[#f5b932] font-bold mb-3">
                2024 - 2027
              </p>
